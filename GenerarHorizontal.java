// Implementa la generación de sopas de letras con palabras ocultas en direcciones horizontales.

package uabc.inc.proyectofinal;

import java.util.Random;

public class GenerarHorizontal extends GeneradorSopaDeLetras {
    @Override
    public void generarSopaDeLetras(String nombreArchivo, String[] palabras) {
        ...
        for (String palabra : palabras) {
            ...
            do {
                ...
                direccion = random.nextInt(3); // 0: Vertical, 1: Horizontal, 2: Diagonal
    ...
    private String obtenerDireccionTexto(int direccion) {
        switch (direccion) {
            ...
            case 2:
                return "Diagonal";
            default:
                return "No hay mas direcciones disponibles";
        }
    }
}
